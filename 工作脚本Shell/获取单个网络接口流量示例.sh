...
wget -O exsi_21 "http://*******.65:8080/cacti/graph_xport.php?local_graph_id=11&rra_id=0&view_type=tree&graph_start=${time3}&graph_end=${time2}"&>/dev/null
...
echo "名称: *******-exsi01-*******.21   时间: $time1     接口名称:bond0     带宽出口流量为: "$c"M"
